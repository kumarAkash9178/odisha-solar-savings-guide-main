    ...
    <footer className="bg-[#1a3c4d] text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-6 max-w-xs mt-4">
              Bringing clean, affordable solar energy to homes and businesses across Odisha.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-300 hover:text-[#4bafdb] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-300 hover:text-[#4bafdb] transition-colors">Home</a>
              </li>
              <li>
                <a href="#benefits" className="text-gray-300 hover:text-[#4bafdb] transition-colors">Benefits</a>
              </li>
              <li>
                <a href="#calculator" className="text-gray-300 hover:text-[#4bafdb] transition-colors">Savings Calculator</a>
              </li>
              <li>
                <a href="#contact" className="text-gray-300 hover:text-[#4bafdb] transition-colors">Contact</a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-300 text-sm">
          ...
          <p className="mt-2">
            Designed to help Odisha residents make the switch to clean solar energy.
          </p>
        </div>
      </div>
    </footer>
